...
class SpatioTemporalDataset(Dataset):
    def __init__(self, mmap_data, spatio_gradient, temporal_gradient, start_idx, end_idx, seq_len,
                 pre_len, features, device, adj_file_list, gradient_mmap, max_mask, move_step=10, normalize=2,
...
class SpatioTemporalDataModuleTest(LightningDataModule):
    def __init__(
            self,
            data_root: str,
            batch_size: int = 1,
...
if __name__ == "__main__":
    ...
    dm = SpatioTemporalDataModuleTest(
